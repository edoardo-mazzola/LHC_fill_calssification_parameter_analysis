...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python src/process_new_raw_data.py <input_raw_filename.pkl> <output_interim_filename.pkl>") ## depending on the file analysed
        print("Example: python src/process_new_raw_data.py Run3_2025_new_data.pkl new_fills_2025_cleaned.pkl") ## depending on the file analysed
        sys.exit(1)
